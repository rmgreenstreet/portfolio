...
module.exports = {
	...
	getRegister(req, res, next) {
		res.render('../views/users/register', { title: 'Robert Greenstreet - Register', page:'register', username:'', email:''});
	},
	// POST /register
	async postRegister(req, res, next) {
        try {
            ...
            res.render('register', { title: 'Robert Greenstreet - Register', page:'register', username, email, error })
        }
	},
	// GET /login
	getLogin(req, res, next) {
		...
		res.render('login', { title: 'Robert Greenstreet - Login' , page:'login'});
	},
	// POST /login
    ...
    async getProfile(req,res,next) {
        ...
        res.render('profile', {posts, title: `Robert Greenstreet - ${req.user.username}'s Profile`, page: 'profile'})
    },
